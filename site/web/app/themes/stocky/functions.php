...
if ( ! function_exists ( 'dcs_related_products' ) ) {
...
if ( ! function_exists ( 'dcs_count_sidebar_widgets' ) ) {
...
if ( ! function_exists ( 'dcs_author_box' ) ) {
...
if ( ! function_exists ( 'dcs_featured_user_widget' ) ) {
...
/*
if ( ! function_exists ( 'dcs_widget_recent_posts' ) ) {
...
if ( ! function_exists ( 'dcs_exif_data' ) ) {
...
if ( ! function_exists ( 'dcs_star_ratings' ) ) {
...
if ( ! function_exists ( 'dcs_edd_wishlist' ) ) {
...
if ( ! function_exists ( 'dcs_edd_wishlist_class' ) ) {
...
function dcs_custom_vendor_header()  {
    ...
    $image = get_user_meta( $vendor->data->ID, 'header_image', true );
	...
	?><style>
		#header, body.page-template-page-login-php { background-image: url( '<?php echo wp_get_attachment_url( $image[0] ); ?>' ); }
	</style><?php
}
